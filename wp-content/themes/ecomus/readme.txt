...
- New: Added website option for [Ecomus] Store Locations
- New: Added link for Support Center on the header
- Updated: Full compatibility with WooCommerce 10.4.3
- Updated: Full compatibility with WordPress 6.9.0
- Fixed: Ecomus Builder doesn't work with WPML

Version 2.4.1

- New: Add custom HTML element to header mobile builder
- Fixed: Some time pagination doesn't work when use Product Archive builder
- Fixed: Some bugs about CSS

Version 2.4.0

- New: Added Home Gaming Accessories demo
- New: Added Home Drinkwear demo
- New: Added Home Supplement demo
- New: Added Buy X Get Y feature
- New: Added load more and infinite scroll pagination options for blog pages
- Updated: Full compatibility with WooCommerce 10.3.0
- Fixed: Product search ajax now correctly filters out products marked as "shop only" or "hidden" visibility
- Fixed: Issue with adding custom HTML content in mega menu builder
- Fixed: Login error message no longer appears incorrectly in registration tab
...
- New: Added Home Personalized Pod demo
- New: Added Home Book Store demo
- New: Added Pre-Order feature
- New: Added a new option to custom link in the navigation bar
- New: Free Shipping Bar supports with specific Zone regions
- Fixed: Marquee discount now works correctly with AJAX pagination

Version 2.2.0

- New: Added a new option to show brand logo in the single product
- New: Added a new option to show post excerpt for blog grid and classic layout
- New: Added a new option to open the product affiliate button link in a new tab
- Updated: Compatible with WooCommerce 10.1.0

Version 2.1.1

- Updated: Compatible with WooCommerce 10.0.2

Version 2.1.0

- New: Added a Footwear demo
- New: Added a Swimwear demo
- New: Added a Camp and Hike demo
- New: Added options to display product videos on product cards
- New: Added option to display flash sale marquee on product cards
- New: Added option to show category description below products on product category page
- New: Added option to customize heading, title and product title HTML tags (H1-H6, div, span, p) for some widgets such as product grid, carousel widgets

Version 2.0.1

- New: Added cart icon behavior option to toggle between panel view and direct page navigation
- New: Add Page Header text color for categories
- Updated: Compatible with WooCommerce 9.9.3

Version 2.0.0

- New: Added a Paddle Boards demo
- New: Added a Skateboard demo
- New: Added a Food demo
- New: Added a Plant demo
- New: Added page header background functionality for post categories
- New: Added Dual Color Swatches feature under WooCommerce > Settings > Products
- New: Added heading size options (H1-H6) for product carousel and grid widgets
- New: Added sorting options for product category filters in Product Filter widget
- New: Added search functionality for attribute filters in Product Filter widget
- Fixed: Buy Now button functionality in quick view modal
- Fixed: JavaScript errors when using Elementor Pro
- Fixed: Product sorting issues with product archive builder
- Fixed: Product search not working when SKU search is disabled
- Fixed: Post Carousel category selection functionality

Version 1.9.0

- New: Added a Jewelry demo
- New: Added a Stroller demo
- New: Added an option to change the product category page header background.
- New: Added an option to prevent users from clicking on out of stock variation swatches(https://prnt.sc/o_icoTBqcUOY)
- New: Added an option to show the catalog sidebar by clicking on the Filter icon on the mobile Toolbar (https://prnt.sc/GzIONOmd2-Zm)
- Updated: Compatible with WooCommerce 9.8.1

Version 1.8.1

- New: Added Search Products by the content 
- Updated: Product Video audio plays when the video is played
- Fixed: The image doesn't change when you pick a different variation on the product page
- Fixed: Private products now excluded from search results
- Fixed: Product video can now be set to the end of the thumbnails

Version 1.8.0

- New: Added a Baby demo
- New: Added a Tee demo
- New: Added a Headphone demo
- New: Added a Phonecase demo
- Updated: Compatible with YITH Pre-Order for WooCommerce plugin
- Updated: Improved style for the single post sidebar
- Fixed: Wrong template for the search blog
- Fixed: The Dynamic Pricing Discount doesn't work with the Single Product Builder
- Fixed: The background of the sticky header doesn't work with the header transparent
