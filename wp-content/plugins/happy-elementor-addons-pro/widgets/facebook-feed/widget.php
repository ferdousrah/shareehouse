...
class Facebook_Feed extends Base {
	...
	protected function facebook_feed_render( $id, $settings ) {
		...
		$ha_facebook_feed_access_token_key = '_ha_facebook_feed_access_token_' . $id;
		$ha_facebook_feed_access_token_data = get_transient( $ha_facebook_feed_access_token_key );
		if ( ! $ha_facebook_feed_access_token_data || $ha_facebook_feed_access_token_data != $access_token ) {
			set_transient( $ha_facebook_feed_access_token_key, $access_token, 12 * HOUR_IN_SECONDS );
		}

		$ha_facebook_feed_page_id_key = '_ha_facebook_feed_page_id_' . $id;
		$ha_facebook_feed_page_id_data = get_transient( $ha_facebook_feed_page_id_key );
		if ( ! $ha_facebook_feed_page_id_data || $ha_facebook_feed_page_id_data != $page_id ) {
			set_transient( $ha_facebook_feed_page_id_key, $page_id, 12 * HOUR_IN_SECONDS );
		}
