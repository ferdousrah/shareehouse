...
class Scrolling_Image extends Base {
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'on_hover_pause',
			[
				'label' => __('On Hover Pause', 'happy-addons-pro'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Yes', 'happy-addons-pro'),
				'label_off' => __('No', 'happy-addons-pro'),
				'default' => 'no',
				// 'frontend_available' => true,
                'prefix_class' => 'ha-scrolling-image-hover-pause--',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.ha-scrolling-image:not(:has(.elementor-widget-container))' => '{{VALUE}}',
				],
	...
	protected function image_css_filter_styles() {
		...
		$this->start_controls_tabs( 'image_item_tabs');
		$this->start_controls_tab(
			'image_item_normal_tab',
			[
		...
		$this->add_group_control(
            ...
            [
                'name' => 'image_item_css_filters',
                'selector' => '{{WRAPPER}} .ha-scrolling-image-item img',
            ]
        );
		...
		$this->add_group_control(
            Group_Control_Css_Filter::get_type(),
            [
                'name' => 'image_item_hover_css_filters',
                'selector' => '{{WRAPPER}} .ha-scrolling-image-item:hover img',
            ]
        );
