...
class Module {
	...
	private function includes() {
		\Ecomus\Addons\Auto_Loader::register( [
			...
			'Ecomus\Addons\Modules\Product_Video\Product_Card'    => ECOMUS_ADDONS_DIR . 'modules/product-video/product-card.php',
		] );
	}
	...
	public function actions() {
		...
		if( get_option( 'ecomus_product_video' ) == 'yes' ) {
			\Ecomus\Addons\Modules\Product_Video\Product_Card::instance();
		}
	}
