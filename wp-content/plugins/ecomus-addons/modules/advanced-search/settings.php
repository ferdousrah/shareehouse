...
class Settings  {
	...
	public function advanced_search_settings( $settings, $section ) {
		if ( 'ecomus_advanced_search' == $section ) {
			...
			$settings[] = array(
				'id'      => 'ecomus_ajax_search_products_by_title',
				'title'   => esc_html__( 'Search Products by Title', 'ecomus-addons' ),
				'type'    => 'checkbox',
				'default' => 'yes',
			);

			$settings[] = array(
				'id'      => 'ecomus_ajax_search_products_by_content',
				'title'   => esc_html__( 'Search Products by Content', 'ecomus-addons' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);
