;( function( elementor, $, window ) {
	...
	var TemplateLibraryTemplateView = Marionette.ItemView.extend({
		className: function className() {
			...
			if ('ecomus_ext' === source) {
				...
				if( 'woocommerce' === this.model.get('type') || 'homepage' === this.model.get('type') ) {
	...
	var TemplateLibraryCollectionView = Marionette.CompositeView.extend({
		...
		onRenderCollection: function onRenderCollection() {
			...
			if ('ecomus_ext' === ecomus_ext_templates_lib.templates.getFilter('source') && 'page' !== ecomus_ext_templates_lib.templates.getFilter('type') && 'woocommerce' !== ecomus_ext_templates_lib.templates.getFilter('type') && 'homepage' !== ecomus_ext_templates_lib.templates.getFilter('type') ) {
				this.setMasonrySkin();
			}
		},
	...
	var Component = function(ComponentModal) {
		...
		Component.prototype.onDocumentLoaded = function( document ) {
			this.setDefaultRoute( 'templates/homepage' );
	...
	var TemplateLibraryManager = function TemplateLibraryManager() {
		...
		this.filterTemplates = function () {
			return templatesCollection.filter(function (model) {
				...
				return 'block' === model.get('type') || 'page' === model.get('type') || 'woocommerce' === model.get('type') || 'homepage' === model.get('type');
			});
		};
