...
class Product_Tabs_Grid extends Widget_Base {
	...
	protected function section_content() {
		...
		$this->add_control(
			'heading_size',
			[
				'label' => __( 'Heading Size', 'ecomus-addons' ),
	...
	protected function section_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ecomus-product-tabs-grid__heading h4, {{WRAPPER}} .ecomus-product-tabs-grid__heading .h4',
				'condition'   => [
					'show_heading' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .ecomus-product-tabs-grid__heading h4, {{WRAPPER}} .ecomus-product-tabs-grid__heading .h4' => 'color: {{VALUE}};',
				],
				'condition'   => [
					'show_heading' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ecomus-product-tabs-grid__heading h4, {{WRAPPER}} .ecomus-product-tabs-grid__heading .h4' => 'text-align: {{VALUE}}',
				],
				'condition'   => [
					'show_heading' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ecomus-product-tabs-grid__heading.has-heading span' => 'border-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .ecomus-product-tabs-grid__heading.has-heading a' => 'border-width: {{SIZE}}{{UNIT}};',
	...
	protected function render() {
        ...
        echo '<div '. $this->get_render_attribute_string( 'wrapper' ) . '>';
            echo '<div '. $this->get_render_attribute_string( 'heading' ) . '>';
				if ( $settings['show_heading'] == 'yes' && ! empty( $settings['heading_text'] ) ) {
					echo '<'. $settings['heading_size'] .' class="h4">'. wp_kses_post( $settings['heading_text'] ) .'</'. $settings['heading_size'] .'>';
            ...
            echo '</div>';
			add_filter( 'ecomus_product_card_title_heading_tag', [ $this, 'product_card_title_heading_tag' ], 5 );
        ?>
        ...
        <?php
        echo '</div>';
		remove_filter( 'ecomus_product_card_title_heading_tag', [ $this, 'product_card_title_heading_tag' ], 5 );
	}
