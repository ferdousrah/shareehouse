...
class Image_Box_Grid extends Widget_Base {
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} {{CURRENT_ITEM}} .ecomus-image-box-grid__title' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_style() {
		...
		$this->add_responsive_control(
			'title_line',
			[
				'label'   => esc_html__( 'Title in a line', 'ecomus-addons' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'tablet_default'=> 'yes',
				'mobile_default'=> 'yes',
	...
	protected function render() {
		...
		$class_wrapper = '';
		if ( 'yes' !== $settings['title_line'] ) {
			$class_wrapper .= ' title-line-no';
		}
		if ( isset( $settings['title_line_tablet'] ) && 'yes' !== $settings['title_line_tablet'] ) {
			$class_wrapper .= ' title-line-no-tablet';
		}

		if ( isset( $settings['title_line_mobile'] ) && 'yes' !== $settings['title_line_mobile'] ) {
			$class_wrapper .= ' title-line-no-mobile';
		}
        $this->add_render_attribute( 'wrapper', 'class', [ 'ecomus-image-box-grid', $class_wrapper ] );
        ...
        $this->add_render_attribute( 'image', 'class', [ 'ecomus-image-box-grid__image', 'em-relative', $settings['hover_zoom'] == 'yes' ? 'em-eff-img-zoom' : ''  ] );
            ...
            <div <?php echo $this->get_render_attribute_string( 'inner' ); ?>>
                <?php foreach( $settings['items'] as $index => $item ) : ?>
					<?php
						...
						$this->add_render_attribute( $slide_link_title, 'class', 'text-center' );
					?>
                    <div <?php echo $this->get_render_attribute_string( $slide_item ); ?>>
						...
						<div <?php echo $this->get_render_attribute_string( 'content' ); ?>>
							<?php if( ! empty( $item['title'] ) ) : ?>
								...
								?>
									<<?php echo $settings['title_size']; ?> class="ecomus-image-box-grid__title text-body em-font-semibold">
