...
class Slides extends Carousel_Widget_Base {
	...
	protected function section_content_slides() {
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'default' => [
					'url' => 'https://placehold.co/800x400?text=image',
				],
				'selectors' => [
	...
	protected function section_style_carousel() {
		...
		$this->register_carousel_style_controls('solid', false, true);
	...
	protected function render() {
		...
		$widget_class = '';
		$widget_style = '';
		if( ! empty( $settings['arrows_horizontal_large_spacing'] ) && !empty($settings['arrows_horizontal_large_spacing']['size'] ) ) {
			$widget_class = 'ecomus-slides__arrows-large--yes';
			$widget_style = '--arrows-horizontal-large-spacing:' . $settings['arrows_horizontal_large_spacing']['size'] . $settings['arrows_horizontal_large_spacing']['unit'];
		}
		$this->add_render_attribute( 'wrapper', 'class', [ 'ecomus-slides-elementor', 'ecomus-carousel--elementor', 'swiper', $widget_class ] );
		$this->add_render_attribute( 'wrapper', 'stytle', [ $widget_style ] );
					...
					<div class="elementor-repeater-item-<?php echo esc_attr( $slide['_id'] ); ?> ecomus-slides-elementor__item swiper-slide <?php echo esc_attr( $slide_classes ); ?>">
						<div <?php echo $this->get_render_attribute_string( 'slide' ); ?>>
							...
							<div <?php echo $this->get_render_attribute_string( 'content' ); ?>>
								...
								<?php if ( $slide['title'] ) : ?>
									<<?php echo esc_attr( $settings['title_size'] ); ?> <?php echo $this->get_render_attribute_string( 'title' ); ?>><?php echo wp_kses_post( $slide['title'] ); ?></<?php echo esc_attr( $settings['title_size'] ); ?>>
								<?php endif; ?>
