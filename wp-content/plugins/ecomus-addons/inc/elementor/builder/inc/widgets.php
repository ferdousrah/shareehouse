...
class Widgets {
	...
	public function init_widgets() {
		...
		if( get_option( 'ecomus_buy_x_get_y' ) === 'yes' ) {
			$widgets_manager->register( new \Ecomus\Addons\Elementor\Builder\Widgets\Buy_X_Get_Y() );
		}
		...
		$widgets_manager->register( new \Ecomus\Addons\Elementor\Builder\Widgets\Archive_Description() );
