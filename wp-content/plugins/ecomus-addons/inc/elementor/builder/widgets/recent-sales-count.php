...
class Recent_Sales_Count extends Widget_Base {
	...
	protected function render() {
		...
		if ( \Ecomus\Addons\Elementor\Builder\Helper::is_elementor_editor_mode() ) {
			...
			add_filter( 'ecomus_recent_sales_count_text', [ $this, 'ecomus_get_text'], 10, 33 );
			...
			remove_filter( 'ecomus_recent_sales_count_text', [ $this, 'ecomus_get_text'], 10, 3 );
	...
	public function ecomus_get_text( $text, $html_number, $hours ) {
		$settings = $this->get_settings_for_display();
