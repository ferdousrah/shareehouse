...
class Helper {
	...
	public static function product_card_layout_default() {
		if ( class_exists( '\Ecomus\Helper' ) && method_exists( '\Ecomus\Helper', 'product_card_layout_default' ) ) {
			return \Ecomus\Helper::product_card_layout_default();
		}
	...
	public static function product_card_layout_select() {
		...
		if ( class_exists( '\Ecomus\WooCommerce\Helper' ) && method_exists( '\Ecomus\WooCommerce\Helper', 'product_card_layout_select' ) ) {
			return array_merge( $product_layout, \Ecomus\WooCommerce\Helper::product_card_layout_select() );
		}
